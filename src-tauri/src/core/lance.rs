...
/// Returns the OS-appropriate AppData directory for LanceDB storage.
/// Uses `dirs::data_local_dir()` which maps to:
///   Linux:   ~/.local/share/chronos/vectordb
///   macOS:   ~/Library/Application Support/chronos/vectordb
///   Windows: %LOCALAPPDATA%\chronos\vectordb
